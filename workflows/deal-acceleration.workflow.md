...
description: Full account intelligence, deal strategy, stakeholder outreach, and meeting prep for high-value deals
author: octave
tags: [deal, pipeline, account, strategy]
inputs:
  - name: company_domain
    type: string
    required: true
...
Accelerate a high-value deal with account intelligence, stakeholder mapping, deal strategy, and tailored outreach.
...
template: |
  ...
  3. Run /octave:pipeline for ongoing deal strategy
