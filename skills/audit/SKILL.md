...
Separate structural population coverage, semantic sample, source freshness, runtime validation, blockers and intentional exceptions. Commercial identity determines offerings; shared buyers or quotas alone do not justify collapse. Verify destination writes and all consumers before archiving sources. Persist scoped expiring exceptions.
