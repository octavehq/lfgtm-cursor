...
Parse the provided source before asking for already available facts. Preserve speaker, account/opportunity and committee scope. Score only eligible evidence with anchored scales; use N/A where absent. Separate buyer commitment from seller suggestion and follow-up recommendation.
...
- [conversation output template](references/conversation-output-template.md)
