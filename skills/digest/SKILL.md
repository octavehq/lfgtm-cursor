...
- [content packet](references/content-packet.md)

- [evidence and links](references/evidence-and-links.md)
- [format routing](references/format-routing.md)
...
- [digest_state.py](scripts/digest_state.py)
